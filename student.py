...
listStd = ["Morris D. Toclo", "Gabriel Itoka", "Felme Theo Sayon", "Chester Maurice Wisseh", "Enoch Maxwell", "Prince W. Woods"] #List Of Students
...
TTTTTTT  H     H  EEEEE   M    M        BBBBB    OO    Y     Y   ZZZZZZZ
   T	 H     H  E       M MM M        B    B  O  O     Y Y        ZZ
   T     HHHHHHH  EEEEE   M MM M        BBBBB   O  O      Y       ZZ    
   T     H     H  E       M    M        B    B  O  O      Y     ZZ        
   T     H     H  EEEEE   M    M        BBBBB	 OO       Y    ZZZZZZZZZ
	   
	       	   
Enter 1 : To View Member's List 
...
Enter 4 : To Remove Member 
	...
	if(userInput == 1): #This Option Will Print List Of Students
		...
		if(srcStd in listStd): #This Condition Searching The Student
			...
			print("\n=> Go On Any Plantform And Search for {}".format(srcStd))
		else:
			print("\n=> No Record Found Of Member {}".format(srcStd)) #Error Message
		...
		if(rmStd in listStd): #This Condition Removing The Student From The List 
			...
			print("\n=> No Record Found of This Member {}".format(rmStd)) #Error Message
